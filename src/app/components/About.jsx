...
const About = () => {
    return (
        <section className='px-8 sm:px-12 md:px-8 lg:px-24 xl:px-20 lg:h-screen h-auto flex flex-col-reverse md:flex-row gap-16 sm:gap-16 py-24 items-center bg-primary'>
            <div className='w-full md:w-1/2 flex flex-col items-start justify-center gap-8 md:gap-6 lg:gap-8 xl:gap-12'>
            ...
            <div className='w-full md:w-1/2 relative'>
                <div className='relative w-1/2 md:w-2/3 xl:w-1/2 mx-auto'>
                    <Image
