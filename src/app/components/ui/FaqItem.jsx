        ...
        <div className='border-t border-foreground last:border-b'>
            ...
            >
                ...
                <div className={`relative shrink-0 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 mt-1`}>
                    <span
                        className={`absolute left-0 top-1/2 -translate-y-1/2 h-0.5 w-full bg-foreground transition-all duration-200 ease-in-out`}
                    />
                    <span
                        className={`absolute left-1/2 top-0 -translate-x-1/2 w-0.5 h-full bg-foreground transition-all duration-200 ease-in-out
